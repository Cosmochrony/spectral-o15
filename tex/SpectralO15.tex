...
the O6 growth equation $\mathrm{d}p/\mathrm{d}n \lesssim \Rn \, c_\chi \sqrt{p(n)}$
...
\lesssim \Rn \cdot c_\chi \sqrt{p(n)},
\end{equation}
...
\item The Born--Infeld flux bound $c_\chi$, which caps the rate
...
However, the Born--Infeld constraint $|\partial_t \chi_v| \leq c_\chi$
...
\frac{\mathrm{d}p}{\mathrm{d}n}
\lesssim c_\chi \sqrt{p(n)} \cdot \frac{|S_n|}{q} \cdot \Sn.
\end{equation}
...
\[
A \beta n^{\beta - 1}
\lesssim c_\chi \sqrt{A} \, n^{\beta/2}
